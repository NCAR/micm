...
!
!> The rate_constant_wennberg_nitrate_t type
module rate_constant_wennberg_nitrate

  implicit none
  private

  public :: rate_constant_wennberg_nitrate_t

  !> A Wennberg NO + RO2 (nitrate branch) rate constant
  !! (Wennberg et al., Chemical Reviews 118(7):3337-3390, 2018)
  type, extends(rate_constant_t) :: rate_constant_wennberg_nitrate_t
    private
    real :: X_    = 1.0
    real :: Y_    = 0.0
    real :: a0_   = 1.0
  ...
  contains
    ...
    procedure :: calculate
  end type :: rate_constant_wennberg_nitrate_t

  interface rate_constant_wennberg_nitrate_t
    module procedure :: constructor
  end interface rate_constant_wennberg_nitrate_t

contains

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  !> Constructor of Wennberg NO + RO2 (nitrate branch) rate constants
  elemental function constructor( X, Y, a0, n) result( new_obj )

    !> New rate constant
    type(rate_constant_wennberg_nitrate_t) :: new_obj
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  real elemental function calculate( this, environment )
    ...
    associate( T => environment%temperature,                                  &
      ...
      calculate = this%X_ * exp( -this%Y_ / T ) * ( A / ( A + Z ) )
    end associate
...
end module rate_constant_wennberg_nitrate
