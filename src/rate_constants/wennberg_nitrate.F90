...
module micm_rate_constant_wennberg_nitrate
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine calculate( this, environment, rate_constant )
    ...
    do i = 1, ncell
       ...
       rate_constant(i) = this%X_ * exp( -this%Y_ / environment(i)%temperature ) * ( A / ( A + Z ) )
    end do
    !$acc end parallel
...
end module micm_rate_constant_wennberg_nitrate
