...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE Rosenbrock_run(N,Y,Tstart,Tend, &
...
!~~~>  Arguments
   ...
   TYPE(kinetics_type), INTENT(IN)    :: theKinetics
...
!~~~>   Compute the function at current time
   CALL FunTemplate( N, T, Y, theKinetics, Fcn0 )
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1

!~~~>  Compute the function derivative with respect to T
   IF (.NOT.Autonomous) THEN
      CALL ros_FunTimeDerivative( T, Roundoff, Y, Fcn0, theKinetics, dFdT )
   END IF

!~~~>   Compute the Jacobian at current time
   CALL JacTemplate( N, T, Y, theKinetics, Jac0 )
...
Stage: DO istage = 1, ros_S
      ...
      ! istage>1 and a new function evaluation is needed at the current istage
         ELSEIF ( ros_NewF(istage) ) THEN
           ...
           CALL FunTemplate( N, Tau, Ynew, theKinetics, Fcn )
           ISTATUS(Nfun) = ISTATUS(Nfun) + 1
         ENDIF
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  SUBROUTINE ros_FunTimeDerivative ( T, Roundoff, Y, Fcn0, theKinetics, dFdT )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~> Local variables
   ...
   CALL FunTemplate( N, T+Delta, Y, theKinetics, dFdT )
   ISTATUS(Nfun) = ISTATUS(Nfun) + 1
   factor = ONE/Delta
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
END SUBROUTINE Rosenbrock_run
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate( N, T, Y, theKinetics, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE JacTemplate( N, T, Y, theKinetics, Jcb )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
