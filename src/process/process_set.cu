...
namespace micm {
    ...
    {
        //data of matrices
        int ngrids = rate_constants.size(); 
        int nrxns = rate_constants[0].size(); 
        int nspecs = state_variables[0].size();

	std::cout << "number_of_reactants_size = " << number_of_reactants_size \
		  << ", reactant_ids_size = " << reactant_ids_size \
		  << ", number_of_products_size = " << number_of_products_size \ 
		  << ", product_ids_size = " << product_ids_size \
		  << ", yields_size = " << yields_size << std::endl;
