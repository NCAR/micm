...
- **Predecessor:** `PLAN.md` (2026-07-20 performance-and-rigor plan, all phases done)
- **Source:** 2026-07-26 code review of the DAE Rosenbrock path (`rosenbrock.inl`,
  ...
  (ODE repo `paper_dae/`).
- **Status:** Phase 0 fix committed and pushed (`fix-rejection-alpha` @
  `a826c8d0`, 2026-07-26); upstream PR, CI confirmation, and re-measurements
  pending. Phases 1–9 not started.
