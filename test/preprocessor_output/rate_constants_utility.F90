...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine calculate_rate_constants( rate_constants, environment )
    ...
    troe = rate_constant_troe_t( &
      ...
      kinf_A = real( 103323000000000000, kind=musica_dk ), &
    ...
    arrhenius = rate_constant_arrhenius_t( &
      A = real( 13888900000000000, kind=musica_dk ), &
    ...
    troe = rate_constant_troe_t( &
      ...
      kinf_A = real( 1904760000000000, kind=musica_dk ), &
    ...
    troe = rate_constant_troe_t( &
      ...
      kinf_A = real( 275862000000000, kind=musica_dk ), &
    ...
    arrhenius = rate_constant_arrhenius_t( &
      A = real( 160000000000, kind=musica_dk ), &
    ...
    arrhenius = rate_constant_arrhenius_t( &
      A = real( 2400000000000, kind=musica_dk ), &
