...
micm::RosenbrockSolver<LinearSolverPolicy, MatrixPolicy, SparseMatrixPolicy> getSolver(std::size_t number_of_grid_cells)
{
  ...
  return micm::RosenbrockSolver<LinearSolverPolicy, MatrixPolicy, SparseMatrixPolicy>(
...
{
  auto solver = getSolver<LinearSolverPolicy, MatrixPolicy, SparseMatrixPolicy>(number_of_grid_cells);
...
{
  testAlphaMinusJacobian<micm::LinearSolver<double, SparseMatrix>, micm::Matrix, SparseMatrix>(1);
  testAlphaMinusJacobian<micm::LinearSolver<double, SparseMatrix>, micm::Matrix, SparseMatrix>(2);
  testAlphaMinusJacobian<micm::LinearSolver<double, SparseMatrix>, micm::Matrix, SparseMatrix>(3);
  testAlphaMinusJacobian<micm::LinearSolver<double, SparseMatrix>, micm::Matrix, SparseMatrix>(4);
}
...
{
  testAlphaMinusJacobian<micm::LinearSolver<double, Group1SparseVectorMatrix>, Group1VectorMatrix, Group1SparseVectorMatrix>(1);
  testAlphaMinusJacobian<micm::LinearSolver<double, Group2SparseVectorMatrix>, Group2VectorMatrix, Group2SparseVectorMatrix>(4);
  testAlphaMinusJacobian<micm::LinearSolver<double, Group3SparseVectorMatrix>, Group3VectorMatrix, Group3SparseVectorMatrix>(3);
  testAlphaMinusJacobian<micm::LinearSolver<double, Group4SparseVectorMatrix>, Group4VectorMatrix, Group4SparseVectorMatrix>(2);
}