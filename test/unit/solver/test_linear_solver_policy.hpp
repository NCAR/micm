...
void testMarkowitzReordering()
{
  ...
  auto orig_LU_calc = micm::DoolittleLuDecomposition::Create<SparseMatrixPolicy>(orig_jac);
  auto reordered_LU_calc = micm::DoolittleLuDecomposition::Create<SparseMatrixPolicy>(reordered_jac);
