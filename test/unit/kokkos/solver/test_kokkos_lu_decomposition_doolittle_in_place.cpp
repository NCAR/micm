...
using LU1 = micm::LuDecompositionDoolittleInPlace<Sparse1>;
using LU2 = micm::LuDecompositionDoolittleInPlace<Sparse2>;
using LU3 = micm::LuDecompositionDoolittleInPlace<Sparse3>;
using LU4 = micm::LuDecompositionDoolittleInPlace<Sparse4>;

TEST(KokkosLuDecompositionDoolittleInPlace, DenseMatrixVectorOrdering)
{
...
TEST(KokkosLuDecompositionDoolittleInPlace, RandomMatrixVectorOrdering)
{
...
TEST(KokkosLuDecompositionDoolittleInPlace, DiagonalMatrixVectorOrdering)
{
...
TEST(KokkosLuDecompositionDoolittleInPlace, AgnosticToInitialValueVectorOrdering)
{
