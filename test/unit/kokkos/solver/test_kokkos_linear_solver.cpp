...
TEST(KokkosLinearSolver, DenseMatrixVectorOrdering)
{
  TestDenseMatrix<
      Group1VectorMatrix,
...
TEST(KokkosLinearSolver, RandomMatrixVectorOrdering)
{
  TestRandomMatrix<
      Group1VectorMatrix,
      Group1SparseVectorMatrix,
...
TEST(KokkosLinearSolver, VectorOrderingAgnosticToInitialValue)
{
...
TEST(KokkosLinearSolver, DiagonalMatrixVectorOrdering)
{
  TestDiagonalMatrix<
      Group1VectorMatrix,
      Group1SparseVectorMatrix,
...
TEST(KokkosLinearSolver, VectorDiagonalMarkowitzReordering)
{
