...
using LU1 = micm::LuDecompositionDoolittle<Sparse1>;
using LU2 = micm::LuDecompositionDoolittle<Sparse2>;
using LU3 = micm::LuDecompositionDoolittle<Sparse3>;
using LU4 = micm::LuDecompositionDoolittle<Sparse4>;

TEST(KokkosLuDecompositionDoolittle, DenseMatrixVectorOrdering)
{
...
TEST(KokkosLuDecompositionDoolittle, RandomMatrixVectorOrdering)
{
...
TEST(KokkosLuDecompositionDoolittle, DiagonalMatrixVectorOrdering)
{
...
TEST(KokkosLuDecompositionDoolittle, AgnosticToInitialValueVectorOrdering)
{
