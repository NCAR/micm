...
{
  TestCopy<micm::SparseMatrix, micm::SparseMatrixVectorOrderingCompressedSparseColumn<1>, micm::VectorMatrix<double, 1>>();
  TestCopy<micm::SparseMatrix, micm::SparseMatrixVectorOrderingCompressedSparseColumn<2>, micm::VectorMatrix<double, 2>>();
  TestCopy<micm::SparseMatrix, micm::SparseMatrixVectorOrderingCompressedSparseColumn<3>, micm::VectorMatrix<double, 3>>();
  TestCopy<micm::SparseMatrix, micm::SparseMatrixVectorOrderingCompressedSparseColumn<4>, micm::VectorMatrix<double, 4>>();
}
