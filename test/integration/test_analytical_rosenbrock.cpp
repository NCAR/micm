...
{
  test_analytical_robertson(rosenbrock_2stage, 1e-6);
  test_analytical_robertson(rosenbrock_3stage, 1e-6);
  test_analytical_robertson(rosenbrock_4stage, 1e-6);
  test_analytical_robertson(rosenbrock_4stage_da, 1e-6);
  test_analytical_robertson(rosenbrock_6stage_da, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_1, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_2, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_3, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_4, 1e-6);
  test_analytical_robertson(rosenbrock_standard_mozart, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_1, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_2, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_3, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_4, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_csc_1, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_csc_2, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_csc_3, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_csc_4, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_csc_1, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_csc_2, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_csc_3, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_csc_4, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_in_place_1, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_in_place_2, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_in_place_3, 1e-6);
  test_analytical_robertson(rosenbrock_vector_doolittle_in_place_4, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_in_place_1, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_in_place_2, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_in_place_3, 1e-6);
  test_analytical_robertson(rosenbrock_vector_mozart_in_place_4, 1e-6);
}

TEST(AnalyticalExamples, E5)
{
  test_analytical_e5(rosenbrock_2stage, 1e-10);
  test_analytical_e5(rosenbrock_3stage, 1e-10);
  test_analytical_e5(rosenbrock_4stage, 1e-10);
  test_analytical_e5(rosenbrock_4stage_da, 1e-10);
  test_analytical_e5(rosenbrock_6stage_da, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_1, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_2, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_3, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_4, 1e-10);
  test_analytical_e5(rosenbrock_standard_mozart, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_1, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_2, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_3, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_4, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_csc_1, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_csc_2, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_csc_3, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_csc_4, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_csc_1, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_csc_2, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_csc_3, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_csc_4, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_in_place_1, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_in_place_2, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_in_place_3, 1e-10);
  test_analytical_e5(rosenbrock_vector_doolittle_in_place_4, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_in_place_1, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_in_place_2, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_in_place_3, 1e-10);
  test_analytical_e5(rosenbrock_vector_mozart_in_place_4, 1e-10);
}
