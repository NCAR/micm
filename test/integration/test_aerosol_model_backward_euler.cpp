...
{
  test_solve_with_stub_aerosol_models(backward_euler);
  test_solve_with_stub_aerosol_models(backward_euler_vector_1);
  test_solve_with_stub_aerosol_models(backward_euler_vector_2);
  test_solve_with_stub_aerosol_models(backward_euler_vector_3);
  test_solve_with_stub_aerosol_models(backward_euler_vector_4);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_1);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_2);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_3);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_4);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_1);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_2);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_3);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_4);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_csc_1);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_csc_2);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_csc_3);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_csc_4);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_csc_1);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_csc_2);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_csc_3);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_csc_4);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_in_place_1);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_in_place_2);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_in_place_3);
  test_solve_with_stub_aerosol_models(backward_euler_vector_doolittle_in_place_4);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_in_place_1);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_in_place_2);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_in_place_3);
  test_solve_with_stub_aerosol_models(backward_euler_vector_mozart_in_place_4);
}
