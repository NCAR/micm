...
using stateType = micm::CudaState<micm::RosenbrockTemporaryVariables<builderType::DenseMatrixPolicyType>, builderType::DenseMatrixPolicyType, builderType::SparseMatrixPolicyType>;
...
using stateType1Cell = micm::CudaState<micm::RosenbrockTemporaryVariables<builderType1Cell::DenseMatrixPolicyType>, builderType1Cell::DenseMatrixPolicyType, builderType1Cell::SparseMatrixPolicyType>;
