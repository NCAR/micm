...
using builderType = micm::CudaSolverBuilder_Doolittle<micm::CudaRosenbrockSolverParameters, L>;
...
using builderType1Cell = micm::CudaSolverBuilder_Doolittle<micm::CudaRosenbrockSolverParameters, 1>;
