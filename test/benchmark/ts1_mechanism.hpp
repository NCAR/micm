    ...
    inline std::vector<micm::Process> CreateProcesses(const micm::Phase& gas_phase)
    {
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1204428.152, .B_ = 0.0, .C_ = 500.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 873210.4102, .B_ = 0.0, .C_ = 220.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 2.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "COF2"), 2.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 70459046.892, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "ONITR"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1204428.152, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3O2"), 2.0 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 98160894.388, .B_ = 0.0, .C_ = 60.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HCL"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 361328.4456, .B_ = 0.0, .C_ = 230.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "MTERP"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 59619193.524, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO2"), 1.0 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BCARY"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "BCARYO2VBS"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 120442815.2, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 12887381.2264, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "ISOPAO2"), 0.6 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({})
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1.29e-07, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HYDRALD"), 0.87 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3O2"), 0.9 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 1.0 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 0.12 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 722656.8912, .B_ = 0.0, .C_ = 490.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HCOOH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 16861994.128, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 154769017.532, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "F"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 114420674.44, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "C3H7OOH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
                      .A_ = 451660.55700000003, .B_ = 0.0, .C_ = 700.0, .D_ = 300.0, .E_ = 0.0 })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "ISOP"), SpeciesByName(gas_phase, "OH") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "ISOP"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NC4CHO"), 0.8 },
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 301107.038, .B_ = 0.0, .C_ = 400.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "XO2"), 0.5 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 7828782.988, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BZALD"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 481771.2608, .B_ = 0.0, .C_ = 700.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 18066422.28, .B_ = 0.0, .C_ = 200.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "TOLUENE"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "MACRO2"), 0.5 },
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 4155277.1244, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BR"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 3312177.418, .B_ = 0.0, .C_ = 200.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 8430997.064, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 72265689.12, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CLO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 102376.39292, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "C6H5O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 168619.94128, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "C6H5O2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 4516605.57, .B_ = 0.0, .C_ = 290.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HCL"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 8430997.064, .B_ = 0.0, .C_ = 270.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "POOH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
                      .A_ = 451660.55700000003, .B_ = 0.0, .C_ = 700.0, .D_ = 300.0, .E_ = 0.0 })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 0.7 },
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 120442.8152, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 963542.5216, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({})
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1264649.5596, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BR"), 2.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "GLYALD"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NOA"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 42154985.32, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "TERPNIT"), 0.2 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "TERP2O2"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NTERPO2"), 0.5 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 602214.076, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 0.63 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({})
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 4.63e-07, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HYDRALD"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3O2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 8430997.064, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "C2H5OOH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
                      .A_ = 451660.55700000003, .B_ = 0.0, .C_ = 700.0, .D_ = 300.0, .E_ = 0.0 })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3O2"), 0.7 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HYAC"), 0.7 },
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 24088563.04, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 6022.14076, .B_ = 0.0, .C_ = -490.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 278222903.112, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 78287.82988, .B_ = 0.0, .C_ = 360.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 39746129.016, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CO3"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 0.5 },
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "O"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 19873064.508, .B_ = 0.0, .C_ = 55.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HF"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 8430997.064, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NC4CHO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3O2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 8430997.064, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "GLYOXAL"), 0.4 },
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "TERPROD1"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 12044281.52, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "BRO"), SpeciesByName(gas_phase, "CLO") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BRCL"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "GLYALD"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 6022.14076, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BRO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NC4CHO"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1445313.7824, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 2107749.266, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "COF2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 78287829.88, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "XO2"), 0.4 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "GLYOXAL"), 0.16 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({})
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 2.31e-07, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "XYLOL"), 0.15 },
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 10237639.292, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 13248709.672, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BRO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 18066422.28, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 16861994.128, .B_ = 0.0, .C_ = 85.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HBR"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CLO"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1144206.7444, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "C6H5O2"), 0.4 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 0.4 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
                      .A_ = 258952.05268, .B_ = 0.0, .C_ = 1040.0, .D_ = 300.0, .E_ = 0.0 })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({})
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 2.31e-06, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "RO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 270996.3342, .B_ = 0.0, .C_ = 610.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CHO"), 0.4 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 4034834.3092, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "XYLOLO2"), 0.3 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "OH"), SpeciesByName(gas_phase, "XYLENES") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "XYLENES"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "PHENO2"), 0.2 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 0.73 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "PHENO"), 0.07 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 28304061.572, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1083985.3368, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 0.25 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 782878.2988, .B_ = 0.0, .C_ = 640.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "ONITR"), 0.1 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 6022140.76, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "PO2"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HYAC"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
              .SetRateConstant(
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "COF2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 58715872.41, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "ROOH"), 0.85 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "TERPNIT"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 0.75 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3OH"), 0.25 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "MEKOOH"), 0.8 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BENZENE"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO3"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 24088.56304, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CO3"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 3011070.38, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "PHENO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
                      .A_ = 1565756.5976, .B_ = 0.0, .C_ = 365.0, .D_ = 300.0, .E_ = 0.0 })
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "GLYOXAL"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 60221407.6, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 180664.2228, .B_ = 0.0, .C_ = 460.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "NTERPO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 11442067.444, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "TERPROD1"), 0.33 },
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 7226.568912, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "C2H5O2"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CHO"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 0.5 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CHO"), 1.6 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.2 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "C2H5OH"), 0.4 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 40950.557168, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 30110703.8, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "PHENO2"), 0.14 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 0.8 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "N"), SpeciesByName(gas_phase, "NO2") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "N2O"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 21077492.66, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 240885.6304, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HOBR"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3OOH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "TERPO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 19873064.508, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "BENZENE"), SpeciesByName(gas_phase, "OH") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "PHENOL"), 0.53 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H2SO4"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CLO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1987306.4508, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3COCH3"), 0.5 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 210774.9266, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 2.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "TERPROD1"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 1445313.7824, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({})
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 6.34e-08, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HPALD"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 0.4 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CHO"), 0.8 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "RO2"), 0.15 },
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 20475278.584, .B_ = 0.0, .C_ = 0.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 1.0 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 3312177.418, .B_ = 0.0, .C_ = 125.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 0.6 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 0.56 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 301107.038, .B_ = 0.0, .C_ = -424.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "TOLUENE"), SpeciesByName(gas_phase, "OH") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CRESOL"), 0.18 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "CLO"), SpeciesByName(gas_phase, "CLO") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CL2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O2"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BR"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OCLO"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 572103.3722, .B_ = 0.0, .C_ = 550.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BR"), 3.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HCL"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "ISOPNITA"), 0.08 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 0.92 },
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CL2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO3"), 1.0 } })
              .SetRateConstant(
                  micm::ArrheniusRateConstantParameters{ .A_ = 3914391.494, .B_ = 0.0, .C_ = 135.0, .D_ = 300.0, .E_ = 0.0 })
              .SetPhase(gas_phase)
              .Build());
      processes.push_back(
          micm::ChemicalReactionBuilder()
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "H2"), 1.44 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "N"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO3"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 0.66 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "MACR") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.34 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "S"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "O"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "EO"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "MVK"), 0.7 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "MACR"), 0.3 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CH2O"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CO3"), 0.6 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 0.6 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 2.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 2.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BIGALD3"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "OH"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 0.45 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "C3H6"), 0.7 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 0.7 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "BIGALD1"), 1.0 },
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "MALO2"), 0.6 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "MCO3"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_NO2_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_HO2_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_NO3_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_ISOPNITA_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_ISOPNITB_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_GLYOXAL_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_ONITR_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_N2O5_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_HONITR_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_NC4CHO_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_TERPNIT_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_NTERPOOH_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::SurfaceRateConstantParameters{ .label_ = "usr_NC4CH2OH_aer",
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "GLYOXAL"), 0.65 },
                    ...
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "CO"), 0.35 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 1994639.8633289358,
                                                    .k0_B_ = 0.0,
                                                    .k0_C_ = 0.0,
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "CH3CO3"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 4.8841368205828e+17,
                                                    .k0_B_ = -4.1,
                                                    .k0_C_ = -14000.0,
                                                    .kinf_A_ = 1.05545e+17,
                                                    .kinf_B_ = -1.6,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 5297253446296.297,
                                                    .k0_B_ = -3.6,
                                                    .k0_C_ = -8537.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({})
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 35178193.95325578,
                                                    .k0_B_ = -5.6,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 2212.236939328456,
                                                    .k0_B_ = -1.5,
                                                    .k0_C_ = 0.0,
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO3"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 105171.9200664348,
                                                    .k0_B_ = -4.1,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HNO3"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 652791.2279985609,
                                                    .k0_B_ = -3.0,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 65279.12279985608,
                                                    .k0_B_ = -3.4,
                                                    .k0_C_ = 0.0,
                                                    .kinf_A_ = 9033211.14,
                                                    .kinf_B_ = -1.9,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 2901294346.66027,
                                                    .k0_B_ = -3.5,
                                                    .k0_C_ = 0.0,
                                                    .kinf_A_ = 18066422.28,
                                                    .kinf_B_ = 0.0,
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO3"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 249192041415957.1,
                                                    .k0_B_ = -3.0,
                                                    .k0_C_ = -10840.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 6890.574073318142,
                                                    .k0_B_ = -3.6,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 31188914.226597905,
                                                    .k0_B_ = -3.1,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 19221.07504662429,
                                                    .k0_B_ = -1.8,
                                                    .k0_C_ = 0.0,
                                                    .kinf_A_ = 57210337.22,
                                                    .kinf_B_ = 0.4,
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "NO3"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "H2O"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 235.73016566614695,
                                                    .k0_B_ = 0.0,
                                                    .k0_C_ = 1335.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 1885841.3253291757,
                                                    .k0_B_ = -2.4,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 26474310.913274966,
                                                    .k0_B_ = -4.1,
                                                    .k0_C_ = 0.0,
                                                    .kinf_A_ = 5721033.722,
                                                    .kinf_B_ = -1.6,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "ACBZO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 6.4898804328292e+17,
                                                    .k0_B_ = -5.6,
                                                    .k0_C_ = -14000.0,
                                                    .kinf_A_ = 1.03323e+17,
                                                    .kinf_B_ = -1.5,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 32639.56139992804,
                                                    .k0_B_ = -1.5,
                                                    .k0_C_ = 0.0,
                                                    .kinf_A_ = 18066422.28,
                                                    .kinf_B_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 68905.74073318142,
                                                    .k0_B_ = -3.4,
                                                    .k0_C_ = 0.0,
                                                    .kinf_A_ = 2408856.304,
                                                    .kinf_B_ = -0.3,
          ...
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 1.0 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "NO2"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 54486035447619.04,
                                                    .k0_B_ = -3.4,
                                                    .k0_C_ = -10900.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 188584.13253291757,
                                                    .k0_B_ = -3.2,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetProducts({ micm::StoichSpecies{ SpeciesByName(gas_phase, "CL"), 1.0 } })
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 5802588.693320541,
                                                    .k0_B_ = -3.3,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 250236.63739944831,
                                                    .k0_B_ = -1.0,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 90665.44833313345,
                                                    .k0_B_ = -1.8,
                                                    .k0_C_ = 0.0,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              ...
              .SetRateConstant(
                  micm::TroeRateConstantParameters{ .k0_A_ = 870388.303998081,
                                                    .k0_B_ = -3.0,
                                                    .k0_C_ = 0.0,
                                                    .kinf_A_ = 963542.5216,
                                                    .kinf_B_ = 0.1,
      ...
      processes.push_back(
          micm::ChemicalReactionBuilder()
              .SetReactants({ SpeciesByName(gas_phase, "OH"), SpeciesByName(gas_phase, "DMS") })
              .SetProducts(
                  { micm::StoichSpecies{ SpeciesByName(gas_phase, "SO2"), 0.5 },
                    micm::StoichSpecies{ SpeciesByName(gas_phase, "HO2"), 0.5 } })
