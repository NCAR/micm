...
void testSolve(micm::RosenbrockSolver<LinearSolverPolicy, MatrixPolicy, SparseMatrixPolicy> solver, double relative_tolerance = 1.0e-8)
{
...
{
  auto solver = getTwoStageMultiCellChapmanSolver<micm::LinearSolver<double, SparseMatrix>, DenseMatrix, SparseMatrix>(3);
  testSolve(solver, 1.0e-2);
}

TEST(RegressionRosenbrock, ThreeStageSolve)
{
  auto solver = getThreeStageMultiCellChapmanSolver<micm::LinearSolver<double, SparseMatrix>, DenseMatrix, SparseMatrix>(3);
  testSolve(solver);
}

TEST(RegressionRosenbrock, FourStageSolve)
{
  auto solver = getFourStageMultiCellChapmanSolver<micm::LinearSolver<double, SparseMatrix>, DenseMatrix, SparseMatrix>(3);
  testSolve(solver, 1.0e-4);
}

TEST(RegressionRosenbrock, FourStageDASolve)
{
  auto solver = getFourStageDAMultiCellChapmanSolver<micm::LinearSolver<double, SparseMatrix>, DenseMatrix, SparseMatrix>(3);
  testSolve(solver, 1.0e-4);
}

TEST(RegressionRosenbrock, SixStageDASolve)
{
  auto solver = getSixStageDAMultiCellChapmanSolver<micm::LinearSolver<double, SparseMatrix>, DenseMatrix, SparseMatrix>(3);
  testSolve(solver, 1.0e-4);
}

TEST(RegressionRosenbrock, VectorSolve)
{
  auto solver1 = getThreeStageMultiCellChapmanSolver<micm::LinearSolver<double, Group1SparseVectorMatrix>, Group1VectorMatrix, Group1SparseVectorMatrix>(3);
  testSolve(solver1);

  auto solver2 = getThreeStageMultiCellChapmanSolver<micm::LinearSolver<double, Group2SparseVectorMatrix>, Group2VectorMatrix, Group2SparseVectorMatrix>(3);
  testSolve(solver2);

  auto solver3 = getThreeStageMultiCellChapmanSolver<micm::LinearSolver<double, Group3SparseVectorMatrix>, Group3VectorMatrix, Group3SparseVectorMatrix>(3);
  testSolve(solver3);

  auto solver4 = getThreeStageMultiCellChapmanSolver<micm::LinearSolver<double, Group4SparseVectorMatrix>, Group4VectorMatrix, Group4SparseVectorMatrix>(3);
  testSolve(solver4);
}