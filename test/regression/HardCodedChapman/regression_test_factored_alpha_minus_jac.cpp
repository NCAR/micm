...
std::vector<double> call_fortran_factored_alpha_minus_jac(std::vector<double> &dforce_dy, const double &alpha)
{
  ...
  CFI_CDESC_T(1) LU;
  CFI_establish((CFI_cdesc_t *)&LU, NULL, CFI_attribute_pointer, CFI_type_double, 0, (CFI_rank_t)1, NULL);
  ...
  factored_alpha_minus_jac((CFI_cdesc_t *)&f_dforce_dy, alpha, (CFI_cdesc_t *)&LU);
