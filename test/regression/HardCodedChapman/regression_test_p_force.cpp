    ...
    const double &number_density_air)
{
  ...
  CFI_establish((CFI_cdesc_t *)&f_p_force, NULL, CFI_attribute_pointer, CFI_type_double, 0, (CFI_rank_t)1, NULL);
  ...
  CFI_establish(
      ...
      (CFI_rank_t)1,
      number_densities_extent);

  p_force(
      (CFI_cdesc_t *)&f_rate_constants, (CFI_cdesc_t *)&f_number_densities, number_density_air, (CFI_cdesc_t *)&f_p_force);
