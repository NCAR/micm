...
namespace micm
{
  ...
  inline ChempreprocessorLuDecomposition::ChempreprocessorLuDecomposition()
  {
  }

  template<class SparseMatrixPolicy>
  requires(SparseMatrixConcept<SparseMatrixPolicy>) inline ChempreprocessorLuDecomposition::ChempreprocessorLuDecomposition(
  ...
  template<class SparseMatrixPolicy>
  requires(SparseMatrixConcept<SparseMatrixPolicy>) inline ChempreprocessorLuDecomposition ChempreprocessorLuDecomposition::Create(
      const SparseMatrixPolicy& matrix)
  {
    ChempreprocessorLuDecomposition lu_decomp{};
    lu_decomp.Initialize<SparseMatrixPolicy>(matrix, typename SparseMatrixPolicy::value_type());
    return lu_decomp;
  }

  template<class SparseMatrixPolicy>
  requires(SparseMatrixConcept<SparseMatrixPolicy>) inline void ChempreprocessorLuDecomposition::Initialize(
      const SparseMatrixPolicy& matrix,
      auto initial_value)
  {
  ...
  requires(SparseMatrixConcept<SparseMatrixPolicy>) inline std::
      pair<SparseMatrixPolicy, SparseMatrixPolicy> ChempreprocessorLuDecomposition::GetLUMatrices(
  ...
  template<class SparseMatrixPolicy>
  requires(!VectorizableSparse<SparseMatrixPolicy>) inline void ChempreprocessorLuDecomposition::Decompose(
      const SparseMatrixPolicy& A,
