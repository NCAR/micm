  ...
  namespace micm {
    ...
    struct State  {
      ...
      State(const std::size_t state_size, const std::size_t custom_parameters_size,
    ...
    inline State::State(const std::size_t state_size, const std::size_t custom_parameters_size,
                        const std::size_t process_size)
      : temperature_(0)
      , pressure_(0)
      , air_density_(1)
