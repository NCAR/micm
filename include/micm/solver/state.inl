...
namespace micm
{
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::State()
      : conditions_(),
        variables_(),
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::State(const StateParameters& parameters)
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::SetTemporaryVariables(TemporaryVariablesPolicy&& temporary_variables)
  {
    temporary_variables_ = std::move(temporary_variables);
  }

  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::SetConcentrations(
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::SetConcentration(const Species& species, double concentration)
  {
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::SetConcentration(
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::UnsafelySetCustomRateParameters(
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::SetCustomRateParameters(
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::SetCustomRateParameter(const std::string& label, double value)
  {
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::SetCustomRateParameter(
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::PrintHeader()
  {
  ...
  template<class TemporaryVariablePolicy, class DenseMatrixPolicy, class SparseMatrixPolicy>
  inline void State<TemporaryVariablePolicy, DenseMatrixPolicy, SparseMatrixPolicy>::PrintState(double time)
  {
