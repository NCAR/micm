...
namespace micm
{
  ...
  template<class DenseMatrixPolicy, class SparseMatrixPolicy, class LuDecompositionPolicy>
  inline State<DenseMatrixPolicy, SparseMatrixPolicy, LuDecompositionPolicy>::State(const StateParameters& parameters)
        ...
        number_of_grid_cells_(parameters.number_of_grid_cells_)
  {
    ...
    auto lu = LuDecompositionPolicy::template GetLUMatrices<SparseMatrixPolicy>(jacobian_, 0);
