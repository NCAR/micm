      ...
      [this, n](const auto&& A_view, auto&& lower_view, auto&& upper_view)
      {
        ...
        for (std::size_t i = 0; i < n; ++i)
        {
          upper_view.ForEachBlock(
            [](double& uii_inv, const double& uii)
            {
              uii_inv = 1.0 / uii;
            },
            Uii_inverse,
          ...
          for (std::size_t ij = 0; ij < std::get<1>(*uii_nj_nk); ++ij)
          {
            lower_view.ForEachBlock(
              [](double& lji, const double& uii_inv)
              {
                lji *= uii_inv;
              },
          ...
          for (std::size_t ik = 0; ik < std::get<2>(*uii_nj_nk); ++ik)
          {
            ...
            {
              upper_view.ForEachBlock(
                [](double& ujk, const double& lji, const double& uik)
                {
                  ujk -= lji * uik;
                },
            ...
            {
              lower_view.ForEachBlock(
                [](double& ljk, const double& lji, const double& uik)
                {
                  ljk -= lji * uik;
                },
