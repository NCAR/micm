...
#define MICM_PROCESS_ERROR_CODE_RATE_CONSTANT_NOT_FOUND         6
...
#define MICM_ERROR_CATEGORY_STATE                                       "MICM STATE"
#define MICM_STATE_ERROR_CODE_UNKNOWN_SPECIES                           1
#define MICM_STATE_ERROR_CODE_UNKNOWN_RATE_CONSTANT_PARAMETER           2
#define MICM_STATE_ERROR_CODE_INVALID_CONCENTRATION_COUNT_MULTIGRID     3
#define MICM_STATE_ERROR_CODE_INVALID_CUSTOM_RATE_PARAM_COUNT           4
#define MICM_STATE_ERROR_CODE_INVALID_CUSTOM_RATE_PARAM_COUNT_MULTIGRID 5

#define MICM_ERROR_CATEGORY_SOLVER                          "MICM Solver"
#define MICM_SOLVER_ERROR_CODE_UNUSED_SPECIES               1
#define MICM_SOLVER_ERROR_CODE_MISSING_CHEMICAL_SYSTEM      2
#define MICM_SOLVER_ERROR_CODE_MISSING_PROCESSES            3
#define MICM_SOLVER_ERROR_CODE_MISSING_CHEMICAL_SPECIES     4
#define MICM_SOLVER_ERROR_CODE_INVALID_TOLERANCE_SIZE       5
#define MICM_SOLVER_ERROR_CODE_RATE_CONSTANT_NOT_FOUND      6
#define MICM_SOLVER_ERROR_CODE_DUPLICATE_PARAMETER          7
#define MICM_SOLVER_ERROR_CODE_CUDA_CONSTRAINTS_UNSUPPORTED 8
...
#define MICM_ERROR_CATEGORY_CONSTRAINT                          "MICM Constraint"
#define MICM_CONSTRAINT_ERROR_CODE_INVALID_EQUILIBRIUM_CONSTANT 1
#define MICM_CONSTRAINT_ERROR_CODE_UNKNOWN_SPECIES              2
...
#define MICM_CONSTRAINT_ERROR_CODE_DUPLICATE_PARAMETER          7
