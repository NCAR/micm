...
#define MICM_PROCESS_ERROR_CODE_PHASE_IS_NOT_SET                        1
#define MICM_PROCESS_ERROR_CODE_RATE_CONSTANT_IS_NOT_SET                2
#define MICM_PROCESS_ERROR_CODE_TRANSFER_COEFFICIENT_IS_NOT_SET         3
#define MICM_PROCESS_ERROR_CODE_REACTANT_DOES_NOT_EXIST                 4
#define MICM_PROCESS_ERROR_CODE_PRODUCT_DOES_NOT_EXIST                  5
#define MICM_PROCESS_ERROR_CODE_TOO_MANY_REACTANTS_FOR_SURFACE_REACTION 6
