...
#define MICM_PROCESS_ERROR_CODE_REACTANT_DOES_NOT_EXIST                 2
#define MICM_PROCESS_ERROR_CODE_PRODUCT_DOES_NOT_EXIST                  3
#define MICM_PROCESS_ERROR_CODE_PHASE_IS_NOT_SET                        4
#define MICM_PROCESS_ERROR_CODE_RATE_CONSTANT_IS_NOT_SET                5
#define MICM_PROCESS_ERROR_CODE_TRANSFER_COEFFICIENT_IS_NOT_SET         6
